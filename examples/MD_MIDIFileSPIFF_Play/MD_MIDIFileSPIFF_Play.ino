// Test playing a succession of MIDI files from the SPIFFS card.
...
const uint8_t READY_LED = 14;      // when finished
const uint8_t SMF_ERROR_LED = 15;  // SMF error
const uint8_t SD_ERROR_LED = 16;   // SD error
const uint8_t BEAT_LED = 13;       // toggles to the 'beat'
